<?php
$pageTitle = 'Ventas | Administrador';
...
if (isset($_GET['remove'])) {
    ...
    header("Location: index.php?route=admin/ventas");
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_quantity'])) {
    ...
    if ($res === true) {
        ...
        header("Location: index.php?route=admin/ventas&error=" . urlencode($res));
    }
    exit();
}
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="index.php?route=admin/ventas&remove=<?php echo $item['id_producto']; ?>" class="btn btn-sm btn-danger">X</a></td>
                    </tr>
                    <?php endwhile; 
                    else: ?>
