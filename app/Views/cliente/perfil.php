...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['update_profile'])) {
        ...
        if ($res === true) {
            ...
            // Refresh user data
            $user = $profileController->userDAO->getUserById($_SESSION['usuario_id']);
        } else {
            $error = $res;
        }
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                        ...
                        <div class="card-body">
                            <form method="POST">
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Si fue registrado en una venta, su contraseña es su DNI</small>
                                </div>
                                <div class="mb-3">
                    ...
                    <div class="card shadow-sm mt-4">
                        ...
                        <div class="card-body">
                            <p class="mb-2"><strong>Rol:</strong> <span class="badge bg-info"><?php echo strtoupper($user['rol']); ?></span></p>
